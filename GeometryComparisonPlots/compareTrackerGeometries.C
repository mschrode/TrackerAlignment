...
#include "TTree.h"
  ...
  TFile fin("../test/weakModes2012Tmp/mp1377_vs_sagitta_misal.Comparison_commonTracker.root");
  ...
  c->Divide(3,3);
  c->cd(1);
  data->Draw("dy:r", levelCut);
  TH1F* htemp = (TH1F*)gPad->GetPrimitive("htemp");
  htemp->SetTitle("#Delta y (cm) vs. r (cm)");
  ...
  c->Update();
  c->cd(3);
  data->Draw("r*dphi:cos(phi)", levelCut);
   TH1F* htemp = (TH1F*)gPad->GetPrimitive("htemp");
  htemp->SetTitle("r*#Delta #phi (cm) vs. cos(#phi) (cm)");
  TAxis *xaxis = htemp->GetXaxis();
  TAxis *yaxis = htemp->GetYaxis();
  xaxis->SetTitle("r (cm)");
